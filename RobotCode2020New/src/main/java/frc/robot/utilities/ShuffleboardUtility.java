...
public class ShuffleboardUtility {
    ...
    public ShuffleboardUtility(IntakePistonSubsystem intakePistonSubsystem, FlywheelSubsystem flywheelSubsystem,
            LimelightSubsystem limelightSubsystem, TowerSubsystem towerSubsystem, HopperSubsystem hopperSubsystem,
            FlywheelPistonSubsystem flywheelPistonSubsystem, TurretSubsystem turretSubsystem, KickerSubsystem kickerSubsystem) {
    ...
    public void putDriveTab() {
        ...
        SmartDashboard.putNumber("Hopper Encoder", this.kickerSubsystem.getEncoder());
        SmartDashboard.putNumber("Distance from Target", limelightSubsystem.getDistance());
