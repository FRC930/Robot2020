...
public final class Constants {
    ...
    public static final double HOPPER_SHOOTING_SPEED = 1.0;//0.5;//0.6;//0.85;//0.6
    public static final double TOWER_SPEED = 1.0;

    public static final double TOWER_REVERSE_SPEED = -0.5;
    public static final double KICKER_SPEED = 1.0;//0.5;//0.6; // 0.6
    public static final double INTAKE_SPEED = 0.6; // 0.8
    public static final double FLYWHEEL_TELEOP_SPEED = 0.5;//0.62;//0.8;//0.65;
