...
public class DriveCommand extends CommandBase {
  ...
  public void execute() {  
    ...
    gyroSubsystem.driveOdometry.update((Rotation2d.fromDegrees(gyroSubsystem.getHeading())), driveSubsystem.getLeftWheelRotations(), driveSubsystem.getRightWheelRotations());
  }
