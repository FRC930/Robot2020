...
public class RecruitmentPath2 extends SequentialCommandGroup {
  /**
   * Creates a new Autonomous.
   */
  private final double AUTO_SHOOTER_SPEED = 0.8;
  public RecruitmentPath2(DriveSubsystem dSubsystem) {
    ...
    Trajectory trajectory1 = TrajectoryGenerator.generateTrajectory(
        ...
        new Pose2d(inchesToMeters(60.0), inchesToMeters(30.0), new Rotation2d(0)),
        // Pass config
        config
    ...
    Trajectory trajectory2 = TrajectoryGenerator.generateTrajectory(
        ...
        // End 5 feet infront of initiation line
        new Pose2d(inchesToMeters(0.0), inchesToMeters(0), new Rotation2d(180)),
        // Pass config
        config
