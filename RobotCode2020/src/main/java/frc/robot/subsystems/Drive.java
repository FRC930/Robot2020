...
public class Drive extends SubsystemBase {
  ...
  private final SpeedControllerGroup m_leftMotors = new SpeedControllerGroup(left1, left2, left3);
  private final SpeedControllerGroup m_rightMotors = new SpeedControllerGroup(right1, right2, right3);
  ...
  public void driveAt(double stickX, double stickY){
    stickX = -Math.pow(stickX, 3);
    stickY = Math.pow(stickY, 3);
    stickX *= 0.73;
    left1.set(stickY + stickX); 
    right1.set(-(stickY - stickX));
  }
  @Override
